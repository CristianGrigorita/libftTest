...
SRCS =  ft_putchar.c ft_strequ.c ft_strnstr.c \
	ft_putendl_fd.c ft_strrchr.c ft_atoi.c  \
	ft_striteri.c ft_strsplit.c ft_bzero.c ft_memalloc.c \
	ft_putnbr_fd.c ft_strjoin.c ft_strstr.c ft_isalnum.c ft_memccpy.c \
	ft_strlcat.c ft_strsub.c ft_isalpha.c ft_memchr.c \
	ft_putstr_fd.c ft_strlen.c ft_isascii.c ft_memcmp.c \
	ft_strcat.c ft_tolower.c ft_isdigit.c ft_memcpy.c \
	ft_strchr.c ft_toupper.c ft_isprint.c ft_memdel.c \
	ft_strncat.c ft_itoa.c ft_memmove.c ft_strcmp.c \
